...
build_zynaddsubfx:
	...
	cmake $(ZYNADDSUBFX_PATH) \
		...
		-DCMAKE_CXX_FLAGS='-isystem /opt/homebrew/include -ObjC++ -framework CoreVideo' \
		-DCMAKE_OBJCXX_FLAGS='-ObjC++' \
...
TARGET_TAR_FILE	:= $(BUILD_PATH)/zyn-fusion-osx-arm64-$(VER)-$(MODE).tar.bz2
ZYN_FUSION_OUT	:= $(BUILD_PATH)/zyn-fusion-osx-arm64-$(VER)-$(MODE)
